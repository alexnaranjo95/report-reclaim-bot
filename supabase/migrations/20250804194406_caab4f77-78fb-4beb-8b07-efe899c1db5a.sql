-- Add cleanup trigger for stuck processing reports
...
-- Create a function to be called periodically (could be triggered by cron jobs)
...
BEGIN
  ...
  PERFORM cleanup_stuck_processing_reports();
  
  -- Clean up old failed reports (existing function)
  PERFORM cleanup_old_failed_reports();
END;
$function$